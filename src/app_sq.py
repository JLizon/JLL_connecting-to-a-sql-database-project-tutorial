...
con = sq.connect("sq_exercise.db")

# 2) Execute the SQL sentences to create your tables using the SQLAlchemy's execute function

con.executescriptl("""CREATE TABLE publishers(
...
con.executescript("""INSERT INTO publishers(publisher_id, name) VALUES (1, 'O Reilly Media');
